class OpencvQt < Formula
  desc "Open source computer vision library, with optional QT Support"
  ...
  conflicts_with "opencv", :because => "opencv-qt is a replacement for opencv."
  ...
  def install
    ...
    args = std_cmake_args + %W[
      ...
      -DWITH_OPENGL=OFF
      -DWITH_QT=ON
      -DQt5_DIR=#{Formula["qt5"].opt_prefix + 'lib/cmake/Qt5'}
      -DWITH_TBB=ON
      -DWITH_VTK=OFF
